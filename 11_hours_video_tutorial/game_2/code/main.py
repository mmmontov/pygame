...
class Game:
    def __init__(self):
        ...
        self.impact_sound.set_volume(0.01)
    ...
    def bullet_collisions(self):
        if self.bullet_sprites:
            for bullet in self.bullet_sprites:
                collisions_sprites = pygame.sprite.spritecollide(bullet, self.enemy_sprites, False, pygame.sprite.collide_mask)
